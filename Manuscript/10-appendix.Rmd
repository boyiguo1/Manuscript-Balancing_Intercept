...
When the mean statistics (e.g. the prevalence of a disease) of each level/group is given, it is more convenient to 
simulate the outcomes out of each level/group and aggregate the group data to compose the overall data set. For a 2-level example, we can verify the simulation procedure works in this case, as follows
